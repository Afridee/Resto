                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Center(
                          child: Text('Slide it to 100% to confirm your order',
                          style: TextStyle(fontSize: 17, color: Color(0xffdd3572), fontFamily: 'Varela'),),
                        ),
                        SizedBox(height: 20.0),
                        CircleAvatar(
                          radius: 62,
                          ...
                          child: SleekCircularSlider(
                              ...
                              appearance: CircularSliderAppearance(
                                  ...
                                  infoProperties:InfoProperties(
                                      mainLabelStyle: TextStyle(fontSize: 17, color: Colors.white, fontFamily: 'Varela')
                                  )
                              ),
